...
//
// 1. Las redistribuciones del código fuente deben conservar el aviso de derechos de autor anterior, esta lista de
...
//
// ESTE SOFTWARE ES PROPORCIONADO POR <TITULAR DE LOS DERECHOS DE AUTOR> `` TAL CUAL '' Y CUALQUIER EXPRESA O IMPLÍCITA
// GARANTÍAS, INCLUYENDO, PERO NO LIMITADO A, LAS GARANTÍAS IMPLÍCITAS DE COMERCIABILIDAD Y
// SE RECHAZA LA APTITUD PARA UN PROPÓSITO EN PARTICULAR. EN NINGÚN CASO DEBERÁ <TITULAR DE LOS DERECHOS DE AUTOR> O
// LOS COLABORADORES SERÁN RESPONSABLES DE CUALQUIER CUALQUIER DIRECTO, INDIRECTO, INCIDENTAL, ESPECIAL,
// DAÑOS CONSECUENTES (INCLUYENDO, PERO NO LIMITADO A LA ADQUISICIÓN DE BIENES SUSTITUTOS O
// SERVICIOS; PÉRDIDA DE USO, DATOS O BENEFICIOS; O INTERRUPCIÓN COMERCIAL) SIN EMBARGO CAUSADO Y EN
// CUALQUIER TEORÍA DE RESPONSABILIDAD, YA SEA POR CONTRATO, RESPONSABILIDAD ESTRICTA O AGRAVIO (INCLUYENDO
// NEGLIGENCIA O DE OTRO MODO) QUE SURJA DE ALGUNA MANERA DEL USO DE ESTE SOFTWARE, INCLUSO SI
// INFORMADO DE LA POSIBILIDAD DE TALES DAÑOS.
//
// Las opiniones y conclusiones contenidas en el software y la documentación son las del
// autores y no debe interpretarse como representantes de políticas oficiales, ni expresadas
// o implícito, de la Universidad de San Francisco
